...
namespace YoYoStudio.Model
{
    public class BuiltIns
	{
        ...
        public static Command AdvertiseManagementCommand = new Command { Id = _9258StartBackendCommandId + 5, Application_Id = _9258ChatApplication.Id, Name = Text.AdvertiseManagement, IsBuiltIn = true, CommandType = BackendCommandType, ActionName = "AdvertiseManagement" };
        ...
        public static ImageType GlobalSlideAdvertisePic = new ImageType { Id = 12, Name = Text.GlobalSlideAdvertiseImage, IsBuiltIn = true };
        public static ImageType GlobalCompanyAdvPics = new ImageType { Id = 13, Name = Text.GlobalCompanyAdvImage, IsBuiltIn = true };
        public static ImageType GlobalAdvertisePics = new ImageType { Id = 14, Name = Text.GlobalAdvertiseImage, IsBuiltIn = true };
        ...
        public static List<Command> Commands = new List<Command> { AllCommand, DefaultBackendCommand, DefaultFrontendCommand, DefaultUserCommand, ReadOnlyCommand,
            ...
            //9258 Commands
            DefineRoomGroupCommand,DefineRoomCommand,DefineGiftCommand,DefineGiftGroupCommand,QueryGiftInOutCommand,ExchangeCommand  ,AdvertiseManagementCommand
        };
        ...
        public static List<ImageType> ImageTypes = new List<ImageType> { AllImageType, ApplicationImageType, RoleImageType, CommandImageType, RoomGroupImageType, RoomImageType, 
            GiftGroupImageType, GiftImageType, SmileImageType, HeaderImageType,StampImageType,
            GlobalSlideAdvertisePic,GlobalCompanyAdvPics,GlobalAdvertisePics,
        };
