...
namespace YoYoStudio.ChatService.Client
{
	...
	public interface IChatService
	{
        ...
        [System.ServiceModel.OperationContractAttribute(Action = "http://tempuri.org/IChatService/AgentLogin", ReplyAction = "http://tempuri.org/IChatService/AgentLoginResponse")]
        bool AgentLogin(int userId, int agent, string password, string agentPassword = "");
	...
	public partial class ChatServiceClient : System.ServiceModel.DuplexClientBase<IChatService>, IChatService
	{
        ...
        {
            return base.Channel.AgentLogin(userId, agent, password, agentPassword);
        }
