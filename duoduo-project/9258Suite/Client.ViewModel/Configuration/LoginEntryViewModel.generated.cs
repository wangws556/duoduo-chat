...
namespace YoYoStudio.Client.ViewModel
{
	public partial class LoginEntryViewModel
	{
		...
		/// <summary>
		/// Field which backs the IconPath property
		/// </summary>
		private HistoryableProperty<string> iconPath = new HistoryableProperty<string>(string.Empty);

		/// <summary>
		/// Gets / sets the IconPath value
		/// </summary>
		[Browsable(false)]
		public  string IconPath
		{
			get { return iconPath.GetValue(); }
			set { ChangeAndNotifyHistory<string>(iconPath, value, () => IconPath ); }
		}
	}
}
