...
namespace YoYoStudio.Controls.CustomWindow
{
    public abstract class EssentialWindow<ActionType> : ChildWindow<ActionType> where ActionType : struct
    {
        ...
        public EssentialWindow()
        {
            ...
            this.StateChanged += new EventHandler(OnStandardWindow_StateChanged);
            ...
            //TopMost event
            //Window.TopmostProperty.OverrideMetadata((typeof(EssentialWindow<ActionType>)),
        ...
        //{
        //    EssentialWindow<ActionType> mv = (EssentialWindow<ActionType>)d;
        //    if (mv.TopmostChanged != null && (bool)e.NewValue == true)
        ...
        protected virtual void OnStandardWindow_StateChanged(object sender, EventArgs e)
        {
            if (this.WindowState == WindowState.Normal)
            {
                ...
                if (_minimizeButtonState != WindowButtonState.None)
                    this._minimizeButton.Visibility = Visibility.Visible;
            }
            ...
            {
                this._minimizeButton.Visibility = Visibility.Collapsed;
            }
        }
