...
namespace YoYoStudio.DataService.Client.Generated
{
    ...
    public class DSClient 
    {
        ...
        public string AgentLogin(int userId, int agent, string password, string agentPassword = "")
        {
            return client.AgentLogin(application_Id, userId, agent, password, agentPassword);
        }
        ...
        public System.Collections.Generic.List<YoYoStudio.Model.Core.Image> GetImagesWithBody(int userId, string token, string condition, int start, int count)
        {
            return client.GetImagesWithBody(application_Id, userId, token, condition, start, count);
        }
