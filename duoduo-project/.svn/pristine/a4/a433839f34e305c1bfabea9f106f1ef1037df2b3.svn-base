...
namespace YoYoStudio.Client.ViewModel
{
    ...
    public partial class RegisterWindowViewModel : WindowViewModel
    {
        ...
        {
            Messenger.Default.Send<EnumNotificationMessage<Object, LoginWindowAction>>(new EnumNotificationMessage<object, LoginWindowAction>(LoginWindowAction.RegisterSuccess, user));
        }
        ...
        protected override void ReleaseUnManagedResource()
        {
            ...
            {
                Messenger.Default.Send<EnumNotificationMessage<object, LoginWindowAction>>(new EnumNotificationMessage<object, LoginWindowAction>(LoginWindowAction.RegisterCancel));
            }
