    ...
    public partial class RoomWindowViewModel
    {
        ...
        public string UsersJson
        {
            get
            {
                ...
                result.Sort((ClientUserModel x, ClientUserModel y) =>
                    {
                        RoleViewModel xV = ApplicationVM.LocalCache.AllRoleVMs.FirstOrDefault((r) => r.Id == x.Role_Id);
                        RoleViewModel yV = ApplicationVM.LocalCache.AllRoleVMs.FirstOrDefault((r) => r.Id == y.Role_Id);
                        if (xV == null || yV == null)
                            return y.Id - x.Id;
                        if (xV.Order == yV.Order)
                            return y.Id - x.Id;
                        else
                            return yV.Order - xV.Order;
