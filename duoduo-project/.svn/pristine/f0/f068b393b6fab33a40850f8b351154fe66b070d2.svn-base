...
namespace YoYoStudio.DataService.Library
{
    ...
    public interface IDataService
    {
        ...
        [OperationContract(IsOneWay = false)]
        [FaultContract(typeof(DatabaseExceptionMsg))]
        string AgentLogin(int appid, int userId, int agent, string password, string agentPassword = "");
        ...
        [OperationContract(IsOneWay = false)]
        [FaultContract(typeof(DatabaseExceptionMsg))]
        List<Image> GetImagesWithBody(int appid, int userId, string token, string condition = "", int start = -1, int count = -1);
        #endregion
