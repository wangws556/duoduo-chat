...
namespace YoYoStudio.Client.ViewModel
{
	public partial class HallWindowViewModel
	{
		...
		/// <summary>
		/// Field which backs the IsAgent property
		/// </summary>
		private HistoryableProperty<bool> isAgent = new HistoryableProperty<bool>(false);

		/// <summary>
		/// Gets / sets the IsAgent value
		/// </summary>
		[Browsable(false)]
		public  bool IsAgent
		{
			get { return isAgent.GetValue(); }
			set { ChangeAndNotifyHistory<bool>(isAgent, value, () => IsAgent ); }
		}
	}
}
